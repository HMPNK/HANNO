...
#Chrom	mRNAstart	mRNAend	Name	score	strand	CDSstart	CDSend	itemRGB	blockCount	blockLen	blockstart	origName	CDSCLUSTER	description	besthitProt	score	evalue	seed_ortholog	evalue	score	eggNOG_OGs	max_annot_lvl	COG_category	Description	Preferred_name	GOs	EC	KEGG_ko	KEGG_Pathway	KEGG_Module	KEGG_Reaction	KEGG_rclass	BRITE	KEGG_TC	CAZy	BiGG_Reaction	PFAMs	busco1	busco2	busco3	orflen	mRNAlen	cds_exons_count	mRNA_exon_count
awk 'BEGIN{print "##Chrom\tmRNAstart\tmRNAend\tName\tscore\tstrand\tCDSstart\tCDSend\titemRGB\tblockCount\tblockLen\tblockstart\torigName\tCDSCLUSTER\tdescription\tbesthitProt\tscore\tevalue\tseed_ortholog\tevalue\tscore\teggNOG_OGs\tmax_annot_lvl\tCOG_category\tDescription\tPreferred_name\tGOs\tEC\tKEGG_ko\tKEGG_Pathway\tKEGG_Module\tKEGG_Reaction\tKEGG_rclass\tBRITE\tKEGG_TC\tCAZy\tBiGG_Reaction\tPFAMs\tbusco1\tbusco2\tbusco3\tbusco4\torflen\tmRNAlen\tcds_exons_count\tmRNA_exon_count"} {print}'
