...
##VARIABLES: $1=genome.fasta, $2=workingdir, $3=protein.faa (from NCBI refSeq), $4=_rna_from_genomic.fna (from NCBI refSeq) $5=BUSCO-LINEAGE-DIR $6=REFPROTDB
...
grep ">" $6 | awk '{l=length($1);print substr($0,2,l-1)"\t"substr($0,l+2)}' > PROT-DB.desc.txt
