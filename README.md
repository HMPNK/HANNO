...
To benchmark improvement of annotation by adding RNAseq the _E. lucius_ run from above, was supported by _E. lucius_ brain, ovary and testis RNAseq data. Results show improvement in BUSCO statistics is due to reduced number of fragmented Buscos. Annotated CDS and UTR length shows massive improvement of annotated UTRs.
