...
* works very well with diverged ( <100 MY ) input evidence (i.e. using NCBI Refseq annotations), no need for RNAseq from your organism (but still beneficial of course)  
